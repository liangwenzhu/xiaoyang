...
function a3(){
    ...
    for(i=0;i<$(".swiper2 .swiper-slide").length-1;i++){
        var p = $(".swiper2 .swiper-slide").length-3 - i;
    ...
    if(width>768){
         mySwiper = new Swiper('.swiper1',{
            ...
            onSlideChangeStart: function(e){
                var paddleft = $("section[class*='swiper-slide-active']").attr("class").replace(/[^0-9]/ig, "");
                var a=parseInt(paddleft) - 1;
                var bullets =  $(".bullet li");
                var logo = $("#top-nav .navbar-brand img");
                if(a==0){
                    logo.attr("src","icon/nav_logo_white.png");
...
$(function(){
    ...
    }else{ $(".swiper1").removeClass("swiper-no-swiping");
        logo.attr("src","icon/nav_logo.png");
